...
namespace RuleEngine.Test
{
    class RuleCheckerTest
    {
        ...
        [Test]
        public void RuleIsSatisfied_AllRule_IsFalse()
        {
            // Arrange
            List<LiveEvent> liveEventsThatFitIntoRule = new List<LiveEvent>
            {
                new LiveEvent { EventIds = new List<string> { "stopped" }, TurbineId = "ns1", Timestamp = DateTime.Now },
                new LiveEvent { EventIds = new List<string> { "turned180" }, TurbineId = "ns2", Timestamp = DateTime.Now.AddSeconds(10) }
            };
        ...
        [Test]
        public void RuleIsSatisfied_AnyRule_IsFalse()
        {
            // Arrange
            List<LiveEvent> liveEventsThatFitIntoRule = new List<LiveEvent>
            {
                new LiveEvent { EventIds = new List<string> { "turned180" }, TurbineId = "bp1", Timestamp = DateTime.Now },
                new LiveEvent { EventIds = new List<string> { "turned180" }, TurbineId = "bg1", Timestamp = DateTime.Now.AddSeconds(10) },
            };
        ...
        public void RuleIsSatisfied_SingleRule_IsFalse()
        {
            ...
            List<LiveEvent> liveEventsThatFitIntoRule = new List<LiveEvent>
            {
                ...
                new LiveEvent { EventIds = new List<string> { "started" }, TurbineId = "bp1", Timestamp = DateTime.Now.AddSeconds(20) },
                new LiveEvent { EventIds = new List<string> { "started" }, TurbineId = "bg1", Timestamp = DateTime.Now.AddSeconds(30) },
                new LiveEvent { EventIds = new List<string> { "stopped"}, TurbineId = "bp2", Timestamp = DateTime.Now.AddSeconds(40) }
            };
